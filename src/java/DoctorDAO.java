...
public class DoctorDAO {
	...
	public boolean registerDoctor(Doctor d) {
		...
		try {
			String sql = "insert into doctor_details(dname,dob,qualification,specialist,demail,mob,dpassword) values(?,?,?,?,?,?,?)";
	...
	public boolean updateDoctor(Doctor d) {
		...
		try {
			String sql = "update doctor_details set full_name=?,dob=?,qualification=?,specialist=?,email=?,mobno=?,password=? where id=?";
			PreparedStatement ps = conn.prepareStatement(sql);
			ps.setString(1, d.getFullName());
			ps.setString(2, d.getDob());
			ps.setString(3, d.getQualification());
